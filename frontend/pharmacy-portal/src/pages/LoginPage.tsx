...
import PharmacyFullScreenLoader from '../components/PharmacyFullScreenLoader';
export default function PharmacyLoginPage() {
  ...
  // show full-screen loader while the auth hook is transitioning
  if (isTransitioning) {
    return <PharmacyFullScreenLoader />;
  }
      ...
      <Card className="w-full max-w-md bg-white/95 backdrop-blur
        ...
        <CardHeader className="text-center space-y-3">
          <div className="mx-auto flex h-14 w-14 items-center justify-center
            ...
            <User2 className="h-7 w-7 text-emerald-600" />
          </div>
