...
>(null);
  ...
  // 🔹 Load profile safely
  // ProfileSection.tsx - Inside your useEffect
  useEffect(() => {
    if (!user) return;
...
setTimeout(() => {
  ...
  {showSuccess && (
      ...
      >
        ...
        <div className="relative w-20 h-20 mb-4">
          ...
          {!showTick && (
            <div className="absolute inset-0 flex items-center justify-center">
              ...
              <div
                ...
                "
              >
                <User className="w-8 h-8 text-[#123B6B]" />
              </div>
            </div>
          )}
          ...
          {showTick && (
            ...
            >
              <svg
                className="w-10 h-10 text-[#123B6B] animate-success-check"
                fill="none"
                stroke="currentColor"
                strokeWidth="3"
                viewBox="0 0 24 24"
    ...
    <div className="space-y-6 max-w-3xl mx-auto">
      <div>
        <h1 className="text-3xl font-bold text-black mb-1">My Profile</h1>
      ...
      <Card>
        <CardContent className="p-6 space-y-6">
          ...
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 bg-blue-100 text-[#123B6B] flex items-center justify-center rounded-full text-xl font-bold">
          ...
          {!editMode && !passwordMode && (
            <>
              ...
              <div className="space-y-2">
                <Button
                  className="w-full bg-[#123B6B] hover:bg-[#0a2a50] text-white"
...
"
                ...
                <div className="flex gap-2">
                  <Button
                    className="bg-[#123B6B] hover:bg-[#0a2a50] text-white"
                    onClick={saveProfile}
                  >
                    Save Changes
                  </Button>
