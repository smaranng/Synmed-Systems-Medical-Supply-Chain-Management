...
export default function Header() {
  ...
  return (
    <header className="bg-[#0A1D37] text-white shadow-md">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          {/* Logo */}
          <Link to="/" className="flex items-center space-x-2">
            <div className="w-10 h-10 bg-[#18599d] rounded-lg flex items-center justify-center">
          ...
          <div className="flex items-center space-x-4">
            {isAuthenticated ? (
              ...
              <>
                <Link to="/login">
                  <Button variant="outline" size="sm" className="bg-[#1288d2] text-white border-[#1288d2] hover:bg-[#0e6fab] hover:text-white">
                    Login
                  </Button>
                </Link>
                <Link to="/register">
